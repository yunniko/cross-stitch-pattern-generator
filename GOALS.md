...
- **Acceptance criteria:**
  ...
  3. Dithering earns its place where it should: on a gradient fixture at 8 and 16 colours, every pattern's mean
     per-cell OKLab error is **lower** than the same chart undithered. Measured per pattern, in a comparison document.
