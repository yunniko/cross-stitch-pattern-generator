...
Last verified: 2026-09-20 at b68db8b (G-049: pixel art in and out, deployed and verified live)
...
**Production** runs b68db8b (2026-09-20), the last deployed commit: the 1b shell with the Owner's corrections, and generation, the enhancement preview and every export but the editable save running in the `processor` container — the work itself in the Rust sidecar (D190, D193), with TypeScript as the fallback.
