...
- **PENDING APPROVAL: G-041 sign-off.** Double-click fill is optional and live (D146), on by default; with the switch off a double-click is two ordinary click steps. Left open from G-039: ending a drag costs 116–132 ms at a 6 px stitch against a 100 ms target, a drag's first frame paints in full (34–77 ms), and a drag with symmetry on keeps the pre-M3 cost (D145).
