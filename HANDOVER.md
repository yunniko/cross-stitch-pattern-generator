...
Last verified: 2026-09-22 at 00a8d16 (G-056: the stamp painter, deployed and verified live)
...
**Production** runs 00a8d16 (2026-09-22), the last deployed commit: the 1b shell with the Owner's corrections, and generation, the enhancement preview and every export but the editable save running in the `processor` container — the work itself in the Rust sidecar (D190, D193), with TypeScript as the fallback.
