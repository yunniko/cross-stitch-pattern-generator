...
Date: 2026-09-13 · Goal: G-031 M3 · Status: historical (the bench it describes was deleted in G-068 M3; see D221)
...
Evidence: as of commit bf726db, before the deletion — scripts/bench.ts; vitest.bench.config.ts; docs/reviews/2026-09-13-pipeline-performance.md.
