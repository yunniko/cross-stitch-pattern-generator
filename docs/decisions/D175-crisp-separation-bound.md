...
Date: 2026-09-19 · Goal: G-047 M4 · Status: historical (the TypeScript Crisp it describes was deleted in G-068 M3; see D221)
...
Evidence: as of commit bf726db, before the deletion — tests/unit/crisp-separation-bound.spec.ts; tests/unit/crisp-evidence-equivalence.spec.ts; docs/reviews/2026-09-19-algorithm-review.md
