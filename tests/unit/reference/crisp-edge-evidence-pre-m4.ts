// Verbatim copy of lib/crisp/crisp-edge-evidence.ts before G-035 M4 (commit c93a85f), kept only as the reference for
// tests/unit/crisp-evidence-equivalence.spec.ts. Only its two import paths were changed. Never edit it.
import { oklabDistanceSquared, oklabFromBytes, type Oklab } from "@/lib/color/color";
