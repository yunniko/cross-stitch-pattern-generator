...
export default defineConfig({
  test: {
    include: ["scripts/rust-parity.ts", "scripts/rust-export-parity.ts", "scripts/dither-comparison.ts", "scripts/colour-floor-comparison.ts", "scripts/hand-drawn-samples.ts", "scripts/hand-drawn-shapes.ts"],
    testTimeout: 0,
    hookTimeout: 0,
